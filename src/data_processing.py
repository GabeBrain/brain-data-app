...
CODIGOS_PARA_TEXTO_ORIGINAL = {
    ...
    "I1P2": "Olá, meu nome é (entrevistador) e eu estou realizando uma pesquisa de opinião para a Brain Inteligência Estratégica. O áudio desta entrevista será gravado para garantia da qualidade dos dados e suas respostas serão tratadas de forma anônima e de acordo com a LGPD (Lei Geral de Proteção de Dados). Você nos autoriza?",
    "FE2P4": "Qual é o seu nome?",
    "FE2P8": "Em qual bairro você mora?",
    "FE2P9": "Na compra de um imóvel para sua família, você seria um dos decisores da compra?",
    "FE2P11": "O rendimento de quantas pessoas compõe esta renda familiar mensal?",
    "FE2P13": "E a sua renda individual mensal atual, em qual dessas faixas se enquadra?",
    "FE2P14": "Quem contribui com a maior parte da renda familiar?",
    "PS3P18": "Completo ou incompleto?",
    "PS3P26": "Qual a sua profissão?",
    "PS3P27": "Em qual área atua?",
    "PS3P28": "Em qual bairro trabalha?",
    "PS3P157": "Em qual cidade trabalha?",
    "PS3P29": "Em qual área atuava?",
    "PS3P31": "E qual é a ocupação profissional do responsável financeiro de sua residência, ou seja, a profissão da pessoa que paga o maior volume das contas da sua casa?",
    "PS3P16": "Gostaria de reafirmar que não estamos realizando venda de nenhum produto e que seus dados não serão utilizados para nenhum tipo de trabalho de marketing. Para o nosso controle de qualidade entrar em contato com você para confirmar a validade desta entrevista, poderia nos informar seu telefone?",
    "PS3P24": "E quem mora com você?",
    "IIA5P37": "Qual valor total máximo (R$) que PODERIA PAGAR por esse imóvel?",
    "IIA5P38": "Nesta faixa, qual seria o valor ideal (R$)?",
    "IIA5P39": "Qual valor máximo de sinal (entrada no ato) que PODERIA PAGAR por esse imóvel?",
    "IIA5P40": "Nesta faixa, qual seria o valor ideal (R$)?",
    "IIA5P41": "Qual valor máximo de parcela mensal que PODERIA PAGAR por esse imóvel?",
    "IIA5P42": "Nesta faixa, qual seria o valor ideal (R$)?",
    "IIA5P47": "Esse imóvel teria quantos metros quadrados (m²)?",
    "IIA5P48": "Nesta faixa, qual seria o tamanho ideal (m²)?",
    "IIA5P43": "A configuração desse imóvel teria quantos quartos?",
    "IIA5P44": "Desses quartos, quantos seriam do tipo suíte, ou seja, quarto com banheiro próprio integrado?",
    "IIA5P45": "E quantos banheiros no total, contando com suíte, lavabo e banheiro social?",
    "IIA5P46": "E quantas vagas de garagem?",
    "M16P143": "Em nome da Brain, gostaria de agradecer a sua participação. Pode ser que o nosso controle de qualidade entre em contato com você para confirmar a validade desta entrevista. Poderia me confirmar seu telefone para contato?",
    "M16P145": "Podemos manter seu contato para participar de pesquisas futuras da Brain e receber um brinde no momento da sua participação?",
    "APAC9P80": "Conhece a localização do empreendimento?",
    "APAC9P81": "Em uma escala de 1 a 5, você compraria um imóvel nesta localização?",
    "APAC9P82": "Por qual(is) motivo(s) não teria interesse nesta localização?",
    "APAC9P83": "Em uma escala de 1 a 5, você compraria um imóvel com esta implantação?",
    "APAC9P84": "Em uma escala de 1 a 5, você compraria um imóvel com esta estrutura de fachada?",
    "APAC9P85": "Quais as áreas que mais gostou?",
    "APAC9P86": "Em uma escala de 1 a 5, você compraria um imóvel com essas áreas?",
    "APAC9P87": "Em uma escala de 1 a 5, você compraria um imóvel com estas plantas?",
    "APAC9P176": "Agora que você conhece todas as características do empreendimento. Quanto você pagaria por este imóvel de XXm²?",
    "APAC9P178": "E quanto você acha este imóvel de XXm² realmente custaria?",
    "APAC9P177": "Agora que você conhece todas as características do empreendimento. Quanto você pagaria por este imóvel de YYm²?",
    "APAC9P179": "E quanto você acha este imóvel de YYm² realmente custaria?",
    "SPP12P117": "(tabela 1 | xx m²) Em uma escala de 1 a 5, você compraria uma unidade do empreendimento apresentado nesta tabela de preço?",
    "SPP12P119": "(tabela 2 | xx m²) E agora, NESTA TABELA DE PREÇO QUE É MENOR, em uma escala de 1 a 5, você compraria uma unidade deste empreendimento?",
    "SPP12P121": "(tabela 3 | xx m²) E por ESTA TABELA DE PREÇO QUE É MENOR AINDA, em uma escala de 1 a 5, você compraria uma unidade deste empreendimento?",
    "SPP12P110": "(tabela 1 | yy m²) Em uma escala de 1 a 5, você compraria uma unidade do empreendimento apresentado nesta tabela de preço?",
    "SPP12P112": "(tabela 2 | yy m²) E agora, NESTA TABELA DE PREÇO QUE É MENOR, em uma escala de 1 a 5, você compraria uma unidade deste empreendimento?",
    "SPP12P114": "(tabela 3 | yy m²) E por ESTA TABELA DE PREÇO QUE É MENOR AINDA, em uma escala de 1 a 5, você compraria uma unidade deste empreendimento?",
    "motivo1": "E qual o principal motivo por não ter interesse?",
    "cond_pagamento_1": "O que não lhe agradou nas condições de pagamento?",
    "motivo2": "E qual o principal motivo por não ter interesse?",
    "cond_pagamento_2": "O que não lhe agradou nas condições de pagamento?",
    "imagem_preferencia_tipologia": "Em uma possível compra deste imóvel, qual seria sua escolha considerando tamanho e preço?",
    "preferencia_tipologia": "Em uma possível compra deste imóvel, qual seria sua escolha considerando tamanho e preço?",
    "finalidade_compra": "Qual seria a finalidade desta compra?",
    "moradiaPrincipal": "Moradia principal ou segunda moradia/imóvel de lazer?",
    "Cidade": "Cidade",
    "Estado": "Estado",
    "Status": "Status",
    "Geração": "Geração",
